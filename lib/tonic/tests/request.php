...
class RequestTester extends UnitTestCase {
    ...
    function testResourceDataLoading() {
        ...
        $this->assertPattern('|def/request\.php|', str_replace('\\','/',$request->resources['/requesttest/one/two']['filename']));
    ...
    function testAutoloadingOfResources() {
        ...
        $this->assertPattern('|File: '.str_replace('\\','/',dirname(__FILE__)).'/def/Autoload.php|', str_replace('\\','/',$request));
    }
